...
inputPesquisa.addEventListener('keypress', pesquisarFilmesEnter);
buttonPesquisa.addEventListener('click', pesquisarFilmesButton);

function pesquisarFilmesButton() {
...
function pesquisarFilmesEnter(event) {
    if (event.key === 'Enter') {
